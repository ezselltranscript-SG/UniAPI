...
class FixedImageCropperTheBudgetT2Service:
    """Service class for fixed dimension image cropping operations (The Budget template T2)"""

    @staticmethod
    def crop_image_fixed_the_budget_t2(image_data: bytes, filename: str) -> Dict[str, Any]:
        ...
        header_box = (0, int(p_height * 0.00), p_width, int(p_height * 0.25))
        body_box = (0, int(p_height * 0.25), p_width, p_height)
